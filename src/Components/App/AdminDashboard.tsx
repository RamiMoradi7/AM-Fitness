    ...
    return (
        <div className="">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center justify-start">
                            ...
                            <div className="text-xl font-bold flex items-center lg:ml-2.5">
                                ...
                                /                <span className="self-center whitespace-nowrap">AM Fitness</span>
                            </div>
            ...
            <div className="flex overflow-hidden bg-white pt-16">
                <aside id="sidebar" className="fixed hidden mt-24 z-20 h-full top-0 left-0 pt-16 flex lg:flex flex-shrink-0 flex-col w-64 transition-width duration-75" aria-label="Sidebar">
                                                ...
                                                <tr className="text-gray-500">
                                                    ...
                                                    <td className="border-t-0 align-middle text-xs whitespace-nowrap p-4 pb-0">
                                                        <div className="flex items-center">
                                                            ...
                                                            <div className="relative w-full">
                                                                <div className="w-full bg-gray-200 rounded-sm h-2">
                                                                    <div className="bg-purple-500 h-2 rounded-sm mb-72"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
