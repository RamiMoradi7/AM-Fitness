...
export default function TrainingPlanForm({ defaultValues, onSubmit, status, users, mode }: TrainingPlanFormTypes): JSX.Element {
    ...
    return (<div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-green-300 via-green-400 to-green-500 py-12">
        <div className="w-full max-w-4xl bg-white rounded-lg shadow-2xl p-8 md:p-12">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                <div>
                    ...
                    <label htmlFor="duration" className="block text-gray-700 font-semibold mb-2 mt-2">משך התכנית</label>
                    <Input
                        control={control}
                        name="duration"
